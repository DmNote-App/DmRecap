...
function RecapContent() {
  ...
  const handleSaveAsImage = async () => {
    ...
    try {
      ...
      try {
        videoReplacements = replaceVideosWithImages(mainRef.current);
      } catch (videoError) {
